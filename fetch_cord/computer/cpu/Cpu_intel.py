...
class Cpu_intel(Cpu_interface):
    ...
    def get_temp(self):
        if self.os == 'windows':
            raise NotImplementedError("Temperature report for Intel CPU's is not supported on Windows yet.")
        elif self.os == 'macos':
            raise NotImplementedError("Temperature report for Intel CPU's is not supported on MacOS yet.")
        elif self.os == 'linux':
            raise NotImplementedError("Temperature report for Intel CPU's is not supported on Linux yet.")
        else:
